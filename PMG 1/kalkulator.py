...
class Calculator:
    def __init__(self):
        ...
        self.window.title("Kalkulator PMG")
    ...
    def create_delete_button(self):
        button = tk.Button(self.buttons_frame, text="Del", bg=LIGHT_BLUE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
                           borderwidth=5, command=self.delete)
